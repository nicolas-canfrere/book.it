...
final class HotelCatalogueSerializer
{
    ...
    /**
     * @return array{
     *     data: list<array{id: string, name: string, streetAddress: string, postalCode: string, city: string, country: string, createdAt: string, starRating: array{stars: int, superior: bool}|null, amenities: string[]}>,
