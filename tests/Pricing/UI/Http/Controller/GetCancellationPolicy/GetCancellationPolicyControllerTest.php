...
#[Group('functional')]
final class GetCancellationPolicyControllerTest extends AuthenticatedWebTestCase
{
    #[Test]
    public function itGetsCancellationPolicyAndReturns200(): void
    {
        ...
        /** @var array{room_id: string, days_threshold: int, updated_at: string} $body */
        $body = json_decode((string) $response->getContent(), true, 512, \JSON_THROW_ON_ERROR);
        self::assertSame($roomId, $body['room_id']);
        self::assertSame(14, $body['days_threshold']);
        self::assertNotEmpty($body['updated_at']);
    }

    #[Test]
    public function itReturns404WhenNoCancellationPolicySet(): void
    {
        $client = static::createAuthenticatedClient();

        $client->request(
            method: 'GET',
            uri: '/api/v1/rooms/00000000-0000-4000-8000-000000000002/cancellation-policy',
        );
