...
This project is indexed by GitNexus as **book.it** (3811 symbols, 8270 relationships, 29 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
