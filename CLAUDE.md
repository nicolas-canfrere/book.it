...
This project is indexed by GitNexus as **book.it** (3400 symbols, 7394 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
