...
This project is indexed by GitNexus as **book.it** (9248 symbols, 22281 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
