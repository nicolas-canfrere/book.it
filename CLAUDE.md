...
This project is indexed by GitNexus as **book.it** (1043 symbols, 2054 relationships, 3 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
