...
This project is indexed by GitNexus as **book.it** (8774 symbols, 20963 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
