...
This project is indexed by GitNexus as **book.it** (8324 symbols, 19802 relationships, 55 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
