...
This project is indexed by GitNexus as **book.it** (3335 symbols, 7223 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
