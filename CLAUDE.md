...
This project is indexed by GitNexus as **book.it** (8253 symbols, 18856 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
