...
This project is indexed by GitNexus as **book.it** (8413 symbols, 20117 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
