...
This project is indexed by GitNexus as **book.it** (3418 symbols, 7424 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
