...
This project is indexed by GitNexus as **book.it** (4784 symbols, 10580 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
