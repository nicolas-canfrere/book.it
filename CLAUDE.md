...
This project is indexed by GitNexus as **book.it** (4981 symbols, 10888 relationships, 43 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
