...
This project is indexed by GitNexus as **book.it** (6538 symbols, 14119 relationships, 51 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
