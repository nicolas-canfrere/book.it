...
This project is indexed by GitNexus as **book.it** (4581 symbols, 10025 relationships, 35 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
