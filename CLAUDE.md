...
This project is indexed by GitNexus as **book.it** (7332 symbols, 16128 relationships, 51 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
