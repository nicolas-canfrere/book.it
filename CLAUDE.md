...
This project is indexed by GitNexus as **book.it** (2063 symbols, 4243 relationships, 10 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
