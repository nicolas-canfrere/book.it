...
This project is indexed by GitNexus as **book.it** (8351 symbols, 19918 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
