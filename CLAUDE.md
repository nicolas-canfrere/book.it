...
This project is indexed by GitNexus as **book.it** (5268 symbols, 11513 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
