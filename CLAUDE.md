...
This project is indexed by GitNexus as **book.it** (4317 symbols, 9425 relationships, 35 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
